    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      <div className="flex items-center justify-center py-8">
        <div className="text-center relative">
          <h1 className="text-3xl font-normal text-neutral-800" style={{ fontFamily: 'Readex Pro, var(--font-raleway), sans-serif' }}>
            Research
          </h1>
          <div className="text-neutral-600 text-sm mt-6 font-light tracking-wide max-w-2xl mx-auto" style={{ fontFamily: 'Readex Pro, var(--font-raleway), sans-serif' }}>
            <p>
